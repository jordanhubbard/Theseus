...
# JSON gold-set spike (ADR 0002): public dumps/loads oracle + held-out + prompt guard.
verify-json-spike:
	@mkdir -p _build/zspecs
	$(PYTHON) tools/zsdl_compile.py zspecs/theseus_json.zspec.zsdl gold/json/held_out.zspec.zsdl
	$(PYTHON) tools/cleanroom_verify.py _build/zspecs/theseus_json.zspec.json

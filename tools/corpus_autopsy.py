...
# Layer 2 families characterized after the qualification gold set
# (Phase 11, the 2026-09-20 high-feasibility pass, and the 2026-09-21
# medium pass). Not qualification targets (ADR 0005). Medium families whose
# public oracles do not pass the installed library are absent.
CHARACTERIZATION_COHORT = frozenset({
    ...
    "semver_diff",
    "unidecode",
    # 2026-09-21 medium public-API pass. Not qualification targets.
    "argparse",
    "base64_js",
    "codecs",
    "collections",
    ...
    "yaml",
    "yaml_js",
    # 2026-09-21 oracle repair: medium families whose Layer 2 specs now match

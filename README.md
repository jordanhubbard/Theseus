...
**479 specs · 7,937 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 479 ZSDL source specs (committed) |
...
**Covered libraries (479):** abc, abc_extra, abc_meta, accepts, aifc, ajv, antigravity, argparse, argparse_formatters, array, array_extra, ast, ast_extra, asynchat, asyncio, asyncio_events, asyncio_extra, asyncore, atexit, attrs, audioop, base64, base64_extra, bdb, binascii, binascii_extra, bisect, bisect_extra, _bisect, builtins, bz2, bytes, calendar, calendar_extra, certifi, cgi, cgitb, chalk, chardet, charset_normalizer, chunk, click, cmath, cmath_extra, cmd, code, codecs, codeop, builtins_extra, cgi_extra, codecs_extra, collections, collections_abc, collections_extra, collections_namedtuple, collections_ordereddict, colorama, colorsys, colorsys_extra, compileall, compileall_extra, concurrent_futures, concurrent_futures_extra, configparser, configparser_extra, content_type, contextlib, contextlib_extra, contextlib_suppress, contextvars, cookie, copy, copy_extra, copyreg, copyreg_extra, cProfile, crypt, csv, _csv, csv_extra, csv_extra2, ctypes, ctypes_module, curl, curses, curses_extra, curses_ascii, dataclasses, dataclasses_extra, dataclasses_field, datetime, _datetime, datetime_extra, datetime_timedelta, dbm, debug, decimal, _decimal, decimal_extra, decorator, defusedxml, difflib, difflib_extra, dis, dis_extra, distro, dns, doctest, doctest_extra, docutils, dotenv, elementtree, email_charset, email_encoders, email_errors, email_extra, email_header, email_message, email_mime, email_mime_extra, email_policy, email_utils, ensurepip, enum, enum_extra, enum_extra2, enum_flags, errno, etag, expat, express, fcntl, filecmp, filecmp_extra, fileinput, filelock, fnmatch, fnmatch_extra, fontTools, formatter, fractions, fractions_extra, fresh, fsspec, ftplib, functools, functools_extra, functools_lru, future, gc, gc_extra, genericpath, genericpath_extra, getopt, getpass, getpass_extra, gettext, gettext_extra, glob, glob_extra, grp, gzip, gzip_extra, hashlib, hashlib_extra, hashlib_extra2, _hashlib, heapq, heapq_extra, _heapq, hmac, hmac_extra, html, html_entities, html_extra, html_parser, http_client, http_cookiejar, http_cookies, http_server, http_server_handlers, http_status, idna, imaplib, imghdr, importlib, importlib_abc, importlib_extra, importlib_machinery, importlib_metadata, importlib_resources, importlib_util, inspect, inspect_extra, inspect_signature, io, _io, io_extra, io_extra2, io_streams, ipaddress, ipaddress_extra, isodate, itertools, itertools_extra, itertools_product, jq, json, _json, json_decoder, json_encoder, json_extra, json_extra2, keyword, keyword_extra, lib2to3, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, linecache_extra, locale, locale_extra, lodash, logging, logging_config, logging_extra, logging_handlers, logging_nullhandler, lxml, lz4, lzma, mailbox, mailcap, markdown, markupsafe, marshal, math, math_extra, media_typer, methods, mime_types, mimetypes, minimist, mmap, modulefinder, more_itertools, ms, msgpack, multiprocessing, multiprocessing_extra, netrc, networkx, nntplib, ntpath, ntpath_extra, nturl2path, numbers, numbers_extra, numpy, object_inspect, openssl, operator, operator_extra, optparse, os, os_environ, os_extra, os_path, os_path_extra, os_stat, packaging, pathlib, pathlib_extra, pathlib_extra2, pathlib_pure, pathspec, path_to_regexp, pcre2, pdb, pdb_extra, pickle, _pickle, pickletools, pillow, pipes, pkgutil, platform, platform_extra, platformdirs, plistlib, pluggy, poplib, posix, posixpath, posixpath_extra, pprint, pprint_extra, prettier, profile, profile_extra, protobuf, pstats, pstats_extra, psutil, pty, pwd, pyclbr, py_compile, pydoc, pygments, pyparsing, pytz, pyyaml, qs, queue, queue_extra, quopri, random, random_extra, range_parser, re, readline, re_extra, re_extra2, re_patterns, reprlib, reprlib_extra, requests, resource, rich, rlcompleter, runpy, runpy_extra, sched, sched_extra, secrets, secrets_extra, select, select_extra, selectors, selectors_extra, semver, setuptools, shelve, shelve_extra, shlex, shutil, shutil_extra, signal, signal_extra, six, smtpd, smtplib, sndhdr, socket, _socket, socket_extra, socket_extra2, socketserver, sqlite3, sqlite3_cli, sqlite3_extra, ssl, _ssl, ssl_extra, ssl_extra2, stat, statistics, statistics_extra, statistics_extra2, statuses, stevedore, string, string_extra, string_extra2, stringprep, struct, _struct, struct_extra, struct_extra2, struct_extra3, subprocess, subprocess_extra, subprocess_popen, sunau, symtable, sys, sys_extra, sysconfig, sysconfig_extra, syslog, sys_platform, tabnanny, tarfile, telnetlib, tempfile, tempfile_extra, termios, textwrap, textwrap_extra, this, _thread, threading, threading_extra, threading_sync, threading_timer, time, time_extra, timeit, tkinter, token, token_extra, tokenize, tokenize_extra, tomli, tomlkit, tornado, trace, traceback, traceback_extra, tracemalloc, tracemalloc_extra, traitlets, tty, turtle, types, types_extra, typing, typing_extra, typing_extensions, typing_protocol, tzdata, unicodedata, unicodedata_extra, unittest, unittest_extra, unittest_mock, urllib3, urllib_error, urllib_parse, urllib_parse_extra, urllib_request, urllib_request_extra, urllib_response, urllib_robotparser, uu, uuid, uuid_extra, venv, warnings, warnings_extra, wave, weakref, weakref_extra, _weakref, webbrowser, wrapt, wsgiref, xdrlib, xml_dom, xml_etree_extra, xml_minidom, xml_parse, xmlrpc_client, xmlrpc_server, xml_sax, zipapp, zipfile, zipfile_extra, zipimport, zipimport_extra, zlib, zlib_extra, zoneinfo, zope_interface, zstd.

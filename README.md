...
**99 specs · 2,008 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 99 ZSDL source specs (committed) |
...
**Covered libraries (99):** ajv, attrs, base64, binascii, certifi, chalk, chardet, click, collections, colorama, curl, datetime, debug, decimal, decorator, defusedxml, difflib, distro, dns, docutils, dotenv, expat, express, filelock, fontTools, fsspec, functools, hashlib, hmac, idna, ipaddress, isodate, itertools, jq, json, libcrypto, libpng, libsodium, libxml2, libyaml, lodash, lxml, lz4, markdown, markupsafe, math, minimist, more_itertools, ms, msgpack, networkx, numpy, openssl, operator, packaging, path_to_regexp, pathlib, pathspec, pcre2, pillow, platformdirs, pluggy, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, re, requests, rich, secrets, semver, setuptools, shlex, six, sqlite3, sqlite3_cli, statistics, stevedore, string, struct, textwrap, tomli, tomlkit, tornado, traitlets, typing_extensions, tzdata, unicodedata, urllib_parse, urllib3, uuid, wrapt, zlib, zope_interface, zstd.

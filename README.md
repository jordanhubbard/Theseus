...
**108 specs · 2,207 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 108 ZSDL source specs (committed) |
...
**Covered libraries (108):** ajv, attrs, base64, binascii, bytes, calendar, certifi, chalk, chardet, charset_normalizer, click, collections, colorama, cookie, copy, curl, datetime, debug, decimal, decorator, defusedxml, difflib, distro, dns, docutils, dotenv, expat, express, filelock, fontTools, fractions, fsspec, functools, hashlib, hmac, idna, ipaddress, isodate, itertools, jq, json, libcrypto, libpng, libsodium, libxml2, libyaml, lodash, lxml, lz4, markdown, markupsafe, math, mime_types, minimist, more_itertools, ms, msgpack, networkx, numpy, openssl, operator, packaging, path_to_regexp, pathlib, pathspec, pcre2, pillow, platformdirs, pluggy, pprint, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, re, requests, rich, secrets, semver, setuptools, shlex, six, sqlite3, sqlite3_cli, statistics, statuses, stevedore, string, struct, textwrap, tomli, tomlkit, tornado, traitlets, typing_extensions, tzdata, unicodedata, urllib_parse, urllib3, uuid, wrapt, zlib, zope_interface, zstd.

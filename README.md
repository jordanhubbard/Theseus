...
**90 specs · 1,797 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 90 ZSDL source specs (committed) |
...
**Covered libraries (90):** ajv, attrs, base64, binascii, certifi, chalk, chardet, click, collections, colorama, curl, datetime, decimal, decorator, defusedxml, difflib, distro, dns, docutils, dotenv, expat, express, filelock, fontTools, fsspec, functools, hashlib, hmac, idna, ipaddress, isodate, itertools, jq, json, libcrypto, libsodium, libxml2, libyaml, lodash, lxml, lz4, markdown, markupsafe, math, minimist, more_itertools, ms, msgpack, networkx, numpy, openssl, packaging, pathlib, pathspec, pcre2, pillow, platformdirs, pluggy, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, re, requests, secrets, semver, setuptools, six, sqlite3, statistics, stevedore, struct, textwrap, tomli, tomlkit, tornado, traitlets, typing_extensions, tzdata, urllib_parse, urllib3, uuid, wrapt, zlib, zope_interface, zstd.

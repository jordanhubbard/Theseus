...
**147 specs · 3,167 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 147 ZSDL source specs (committed) |
...
**Covered libraries (147):** abc, accepts, ajv, array, ast, attrs, base64, binascii, bisect, bytes, calendar, certifi, chalk, chardet, charset_normalizer, click, cmath, codecs, collections, colorama, content_type, contextlib, cookie, copy, csv, curl, dataclasses, datetime, debug, decimal, decorator, defusedxml, difflib, distro, dns, docutils, dotenv, elementtree, enum, etag, expat, express, filelock, fnmatch, fontTools, fractions, fresh, fsspec, functools, gzip, hashlib, heapq, hmac, html, idna, inspect, io, ipaddress, isodate, itertools, jq, json, keyword, libcrypto, libpng, libsodium, libxml2, libyaml, lodash, logging, lxml, lz4, markdown, markupsafe, math, media_typer, methods, mime_types, minimist, more_itertools, ms, msgpack, networkx, numpy, object_inspect, openssl, operator, os_path, packaging, path_to_regexp, pathlib, pathspec, pcre2, pillow, platformdirs, pluggy, pprint, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, random, range_parser, re, reprlib, requests, rich, secrets, semver, setuptools, shlex, signal, six, sqlite3, sqlite3_cli, statistics, statuses, stevedore, string, struct, sys, tarfile, textwrap, time, token, tomli, tomlkit, tornado, traitlets, types, typing, typing_extensions, tzdata, unicodedata, urllib_parse, urllib3, uuid, warnings, wrapt, zipfile, zlib, zope_interface, zstd.

...
**242 specs · 4,845 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 242 ZSDL source specs (committed) |
...
**Covered libraries (242):** abc, accepts, ajv, argparse, array, ast, asyncio, atexit, attrs, base64, binascii, bisect, builtins, bytes, calendar, certifi, chalk, chardet, charset_normalizer, chunk, click, cmath, cmd, codecs, collections, collections_abc, colorama, compileall, concurrent_futures, configparser, content_type, contextlib, contextvars, cookie, copy, copyreg, cProfile, csv, ctypes_module, curl, dataclasses, datetime, dbm, debug, decimal, decorator, defusedxml, difflib, dis, distro, dns, docutils, dotenv, elementtree, email_message, email_utils, enum, errno, etag, expat, express, fileinput, filelock, fnmatch, fontTools, fractions, fresh, fsspec, ftplib, functools, gc, getopt, getpass, glob, grp, gzip, hashlib, heapq, hmac, html, html_parser, http_client, http_cookies, http_cookiejar, http_server, idna, imaplib, importlib, importlib_metadata, inspect, io, ipaddress, isodate, itertools, jq, json, json_decoder, json_encoder, keyword, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, locale, lodash, logging, logging_config, logging_handlers, lxml, lz4, markdown, markupsafe, marshal, math, media_typer, methods, mime_types, mimetypes, minimist, more_itertools, ms, msgpack, multiprocessing, netrc, networkx, nntplib, numbers, numpy, object_inspect, openssl, operator, optparse, os, os_path, packaging, path_to_regexp, pathlib, pathspec, pcre2, pdb, pickle, pillow, pkgutil, platform, platformdirs, pluggy, poplib, posixpath, pprint, prettier, protobuf, pstats, psutil, pwd, pyclbr, pygments, pyparsing, pytz, pyyaml, qs, queue, quopri, random, range_parser, re, readline, reprlib, requests, rich, runpy, sched, secrets, selectors, semver, setuptools, shelve, shlex, shutil, signal, six, smtplib, socket, socketserver, sqlite3, sqlite3_cli, ssl, stat, statistics, statuses, stevedore, string, struct, subprocess, symtable, sys, sysconfig, tarfile, telnetlib, tempfile, textwrap, threading, time, timeit, token, tokenize, tomli, tomlkit, tornado, traceback, traitlets, tty, types, typing, typing_extensions, tzdata, unicodedata, unittest, urllib3, urllib_error, urllib_parse, urllib_request, urllib_robotparser, uu, uuid, venv, warnings, wave, weakref, webbrowser, wrapt, xml_dom, xml_sax, xmlrpc_client, xmlrpc_server, zipapp, zipfile, zipimport, zlib, zope_interface, zstd.

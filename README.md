...
**214 specs · 4,469 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 214 ZSDL source specs (committed) |
...
**Covered libraries (214):** abc, accepts, ajv, argparse, array, ast, asyncio, atexit, attrs, base64, binascii, bisect, builtins, bytes, calendar, certifi, chalk, chardet, charset_normalizer, click, cmath, cmd, codecs, collections, collections_abc, colorama, concurrent_futures, configparser, content_type, contextlib, cookie, copy, csv, ctypes_module, curl, dataclasses, datetime, dbm, debug, decimal, decorator, defusedxml, difflib, dis, distro, dns, docutils, dotenv, elementtree, email_message, email_utils, enum, errno, etag, expat, express, fileinput, filelock, fnmatch, fontTools, fractions, fresh, fsspec, functools, gc, getopt, getpass, glob, gzip, hashlib, heapq, hmac, html, html_parser, http_client, http_cookies, http_server, idna, importlib, inspect, io, ipaddress, isodate, itertools, jq, json, json_decoder, json_encoder, keyword, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, lodash, logging, logging_config, logging_handlers, lxml, lz4, markdown, markupsafe, marshal, math, media_typer, methods, mime_types, mimetypes, minimist, more_itertools, ms, msgpack, multiprocessing, netrc, networkx, numbers, numpy, object_inspect, openssl, operator, optparse, os, os_path, packaging, path_to_regexp, pathlib, pathspec, pcre2, pdb, pickle, pillow, pkgutil, platform, platformdirs, pluggy, pprint, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, queue, random, range_parser, re, reprlib, requests, rich, runpy, sched, secrets, semver, setuptools, shelve, shlex, shutil, signal, six, smtplib, socket, socketserver, sqlite3, sqlite3_cli, ssl, stat, statistics, statuses, stevedore, string, struct, subprocess, sys, sysconfig, tarfile, tempfile, textwrap, threading, time, token, tokenize, tomli, tomlkit, tornado, traceback, traitlets, types, typing, typing_extensions, tzdata, unicodedata, unittest, urllib3, urllib_error, urllib_parse, urllib_request, urllib_robotparser, uuid, venv, warnings, wave, weakref, wrapt, xml_dom, xml_sax, xmlrpc_client, zipfile, zipimport, zlib, zope_interface, zstd.

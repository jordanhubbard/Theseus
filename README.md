...
**656 specs · 10,135 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
**Covered libraries (656):** abc, abc_extra, abc_meta, accepts, aifc, aifc_extra, ajv, antigravity, argparse, argparse_extra, argparse_formatters, array, array_extra, array_extra2, ast, ast_extra, ast_extra2, asynchat, asyncio, asyncio_events, asyncio_extra, asyncio_extra2, asyncio_extra3, asyncore, atexit, atexit_extra, attrs, audioop, base64, base64_extra, base64_extra2, bdb, bdb_extra, binascii, binascii_extra, binascii_extra2, bisect, bisect_extra, bisect_extra2, _bisect, builtins, bz2, bz2_extra, bytes, calendar, calendar_extra, calendar_extra2, certifi, cgi, cgitb, chalk, chardet, charset_normalizer, chunk, chunk_extra, click, cmath, cmath_extra, cmd, cmd_extra, code, code_extra, codecs, codecs_extra2, codeop, codeop_extra, builtins_extra, builtins_extra2, cgi_extra, cgi_extra2, codecs_extra, collections, collections_abc, collections_extra, collections_extra2, collections_extra3, collections_namedtuple, collections_ordereddict, colorama, colorsys, colorsys_extra, compileall, compileall_extra, compileall_extra2, concurrent_futures_extra2, concurrent_futures, concurrent_futures_extra, configparser, configparser_extra, content_type, contextlib, contextlib_extra, contextlib_extra2, contextlib_extra3, contextlib_suppress, contextvars, cookie, copy, copy_extra, copy_extra2, copyreg, copyreg_extra, copyreg_extra2, cProfile, crypt, csv, _csv, csv_extra, csv_extra2, csv_extra3, ctypes, ctypes_extra, ctypes_module, curl, curses, curses_extra, curses_ascii, dataclasses, dataclasses_extra, dataclasses_extra2, dataclasses_extra3, dataclasses_field, datetime, _datetime, datetime_extra, datetime_extra2, datetime_timedelta, dbm, dbm_extra, debug, decimal, _decimal, decimal_extra, decimal_extra2, decorator, defusedxml, difflib, difflib_extra, difflib_extra2, dis, dis_extra, dis_extra2, distro, dns, doctest, doctest_extra, doctest_extra2, docutils, dotenv, elementtree, email_charset, email_encoders, email_errors, email_extra, email_header, email_message, email_mime, email_mime_extra, email_policy, email_extra2, email_utils, ensurepip, enum, enum_extra, enum_extra2, enum_extra3, enum_flags, errno, errno_extra, etag, expat, express, fcntl, fcntl_extra, filecmp, filecmp_extra, filecmp_extra2, fileinput, fileinput_extra, filelock, fnmatch, fnmatch_extra, fnmatch_extra2, fontTools, formatter, fractions, fractions_extra, fractions_extra2, fresh, fsspec, ftplib, ftplib_extra, functools, functools_extra, functools_extra2, functools_lru, future, gc, gc_extra, gc_extra2, genericpath, genericpath_extra, getopt, getopt_extra, getpass, getpass_extra, gettext, gettext_extra, gettext_extra2, glob, glob_extra, glob_extra2, grp, grp_extra, gzip, gzip_extra, gzip_extra2, hashlib, hashlib_extra, hashlib_extra2, hashlib_extra3, _hashlib, heapq, heapq_extra, heapq_extra2, _heapq, hmac, hmac_extra, hmac_extra2, html, html_entities, html_extra, html_extra2, html_parser, http_client, http_cookiejar, http_cookies, http_extra, http_server, http_server_handlers, http_status, idna, imaplib, imaplib_extra, imghdr, imghdr_extra, importlib, importlib_abc, importlib_extra, importlib_extra2, importlib_machinery, importlib_metadata, importlib_resources, importlib_util, inspect, inspect_extra, inspect_extra2, inspect_signature, io, _io, io_extra, io_extra2, io_extra3, io_extra4, io_streams, ipaddress, ipaddress_extra, ipaddress_extra2, isodate, itertools, itertools_extra, itertools_extra2, itertools_product, jq, json, _json, json_decoder, json_encoder, json_extra, json_extra2, json_extra3, keyword, keyword_extra, keyword_extra2, lib2to3, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, linecache_extra, linecache_extra2, locale, locale_extra, locale_extra2, lodash, logging, logging_config, logging_extra, logging_extra2, logging_handlers, logging_nullhandler, lxml, lz4, lzma, mailbox, mailbox_extra, mailcap, mailcap_extra, markdown, markupsafe, marshal, marshal_extra, math, math_extra, math_extra2, media_typer, methods, mime_types, mimetypes, mimetypes_extra, minimist, mmap, mmap_extra, modulefinder, modulefinder_extra, more_itertools, ms, msgpack, multiprocessing, multiprocessing_extra, multiprocessing_extra2, netrc, netrc_extra, networkx, nntplib, nntplib_extra, ntpath, ntpath_extra, nturl2path, nturl2path_extra, numbers, numbers_extra, numbers_extra2, numpy, object_inspect, openssl, operator, operator_extra, operator_extra2, optparse, optparse_extra, os, os_environ, os_extra, os_extra2, os_extra3, os_path, os_path_extra, os_stat, packaging, pathlib, pathlib_extra, pathlib_extra2, pathlib_extra3, pathlib_pure, pathspec, path_to_regexp, pcre2, pdb, pdb_extra, pdb_extra2, pickle, pickle_extra, _pickle, pickletools, pillow, pipes, pipes_extra, pkgutil, pkgutil_extra, platform, platform_extra, platform_extra2, platformdirs, plistlib, plistlib_extra, pluggy, poplib, poplib_extra, posix, posix_extra, posixpath, posixpath_extra, pprint, pprint_extra, pprint_extra2, prettier, profile, profile_extra, profile_extra2, protobuf, pstats, pstats_extra, psutil, pty, pty_extra, pwd, pwd_extra, pyclbr, pyclbr_extra, py_compile, py_compile_extra, pydoc, pydoc_extra, pygments, pyparsing, pytz, pyyaml, qs, queue, queue_extra, queue_extra2, quopri, quopri_extra, random, random_extra, random_extra2, range_parser, re, readline, readline_extra, re_extra, re_extra2, re_extra3, re_patterns, reprlib, reprlib_extra, reprlib_extra2, requests, resource, rich, rlcompleter, rlcompleter_extra, runpy, runpy_extra, runpy_extra2, sched, sched_extra, sched_extra2, secrets, secrets_extra, secrets_extra2, select, select_extra, select_extra2, selectors, selectors_extra, selectors_extra2, semver, setuptools, shelve, shelve_extra, shelve_extra2, shlex, shlex_extra, shlex_extra2, shutil, shutil_extra, shutil_extra2, signal, signal_extra, signal_extra2, six, smtpd, smtplib, smtplib_extra, sndhdr, sndhdr_extra, socket, _socket, socket_extra, socket_extra2, socket_extra3, socketserver, socketserver_extra, sqlite3, sqlite3_cli, sqlite3_extra, sqlite3_extra2, ssl, _ssl, ssl_extra, ssl_extra2, ssl_extra3, stat, stat_extra, statistics, statistics_extra, statistics_extra2, statistics_extra3, statuses, stevedore, string, string_extra, string_extra2, stringprep, stringprep_extra, struct, _struct, struct_extra, struct_extra2, struct_extra3, subprocess, subprocess_extra, subprocess_extra2, subprocess_popen, sunau, sunau_extra, symtable, symtable_extra, sys, sys_extra, sys_extra2, sys_extra3, sysconfig, sysconfig_extra, syslog, sys_platform, tabnanny, tabnanny_extra, tarfile, tarfile_extra, telnetlib, telnetlib_extra, tempfile, tempfile_extra, tempfile_extra2, termios, termios_extra, textwrap, textwrap_extra, textwrap_extra2, this, this_extra, _thread, threading, threading_extra, threading_extra2, threading_sync, threading_timer, time, time_extra, time_extra2, timeit, timeit_extra, tkinter, tkinter_extra, token, token_extra, token_extra2, tokenize, tokenize_extra, tokenize_extra2, tomli, tomlkit, tornado, trace, traceback, traceback_extra, traceback_extra2, tracemalloc, tracemalloc_extra, tracemalloc_extra2, traitlets, tty, tty_extra, turtle, turtle_extra, types, types_extra, types_extra2, typing, typing_extra, typing_extra2, typing_extra3, typing_extensions, typing_protocol, tzdata, unicodedata, unicodedata_extra, unicodedata_extra2, unittest, unittest_extra, unittest_extra2, unittest_mock, urllib3, urllib_error, urllib_error_extra, urllib_parse, urllib_parse_extra, urllib_parse_extra2, urllib_request, urllib_request_extra, urllib_response, urllib_robotparser, uu, uu_extra, uuid, uuid_extra, uuid_extra2, venv, venv_extra, venv_extra2, warnings, warnings_extra, warnings_extra2, wave, wave_extra, wave_extra2, weakref, weakref_extra, weakref_extra2, _weakref, webbrowser, webbrowser_extra, webbrowser_extra2, wrapt, wsgiref, xdrlib, xdrlib_extra, xml_dom, xml_etree_extra, xml_extra, xml_minidom, xml_parse, xmlrpc_client, xmlrpc_server, xml_sax, zipapp, zipapp_extra, zipfile, zipfile_extra, zipfile_extra2, zipimport, zipimport_extra, zipimport_extra2, zlib, zlib_extra, zlib_extra2, zoneinfo, zoneinfo_extra, zope_interface, zstd.

...
**400 specs · 6,987 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 400 ZSDL source specs (committed) |
...
**Covered libraries (400):** abc, abc_extra, abc_meta, accepts, aifc, ajv, antigravity, argparse, argparse_formatters, array, ast, asynchat, asyncio, asyncio_events, asyncore, atexit, attrs, audioop, base64, bdb, binascii, bisect, _bisect, builtins, bz2, bytes, calendar, certifi, cgi, cgitb, chalk, chardet, charset_normalizer, chunk, click, cmath, cmd, code, codecs, codeop, builtins_extra, collections, collections_abc, collections_extra, collections_namedtuple, collections_ordereddict, colorama, colorsys, compileall, concurrent_futures, configparser, configparser_extra, content_type, contextlib, contextlib_suppress, contextvars, cookie, copy, copy_extra, copyreg, cProfile, crypt, csv, _csv, csv_extra, ctypes, ctypes_module, curl, curses, curses_ascii, dataclasses, dataclasses_field, datetime, _datetime, datetime_extra, datetime_timedelta, dbm, debug, decimal, _decimal, decimal_extra, decorator, defusedxml, difflib, dis, distro, dns, doctest, docutils, dotenv, elementtree, email_charset, email_encoders, email_errors, email_header, email_message, email_mime, email_mime_extra, email_policy, email_utils, ensurepip, enum, enum_extra, enum_flags, errno, etag, expat, express, fcntl, filecmp, filecmp_extra, fileinput, filelock, fnmatch, fnmatch_extra, fontTools, formatter, fractions, fractions_extra, fresh, fsspec, ftplib, functools, functools_extra, functools_lru, future, gc, gc_extra, genericpath, getopt, getpass, gettext, glob, grp, gzip, hashlib, _hashlib, hashlib_extra, heapq, _heapq, hmac, html, html_entities, html_parser, http_client, http_cookiejar, http_cookies, http_server, http_server_handlers, http_status, idna, imaplib, imghdr, importlib, importlib_extra, importlib_metadata, importlib_resources, importlib_util, inspect, inspect_extra, inspect_signature, io, _io, io_extra, ipaddress, ipaddress_extra, isodate, itertools, itertools_extra, itertools_product, jq, json, _json, json_decoder, json_encoder, json_extra, keyword, keyword_extra, lib2to3, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, locale, lodash, logging, logging_config, logging_extra, logging_handlers, logging_nullhandler, lxml, lz4, lzma, mailbox, mailcap, markdown, markupsafe, marshal, math, math_extra, media_typer, methods, mime_types, mimetypes, minimist, mmap, modulefinder, more_itertools, ms, msgpack, multiprocessing, multiprocessing_extra, netrc, networkx, nntplib, ntpath, nturl2path, numbers, numpy, object_inspect, openssl, operator, operator_extra, optparse, os, os_environ, os_extra, os_path, os_stat, packaging, pathlib, pathlib_extra, pathlib_pure, pathspec, path_to_regexp, pcre2, pdb, pickle, _pickle, pickletools, pillow, pipes, pkgutil, platform, platformdirs, plistlib, pluggy, poplib, posix, posixpath, pprint, pprint_extra, prettier, profile, protobuf, pstats, psutil, pty, pwd, pyclbr, py_compile, pydoc, pygments, pyparsing, pytz, pyyaml, qs, queue, queue_extra, quopri, random, range_parser, re, readline, re_extra, re_patterns, reprlib, requests, resource, rich, rlcompleter, runpy, sched, secrets, select, selectors, semver, setuptools, shelve, shlex, shutil, signal, six, smtpd, smtplib, sndhdr, socket, _socket, socket_extra, socket_extra2, socketserver, sqlite3, sqlite3_cli, ssl, _ssl, ssl_extra, stat, statistics, statistics_extra, statistics_extra2, statuses, stevedore, string, string_extra, stringprep, struct, _struct, struct_extra, subprocess, subprocess_popen, sunau, symtable, sys, sys_extra, sysconfig, syslog, sys_platform, tabnanny, tarfile, telnetlib, tempfile, tempfile_extra, termios, textwrap, textwrap_extra, this, _thread, threading, threading_extra, threading_sync, threading_timer, time, timeit, tkinter, token, tokenize, tomli, tomlkit, tornado, trace, traceback, traceback_extra, tracemalloc, traitlets, tty, turtle, types, types_extra, typing, typing_extensions, typing_protocol, tzdata, unicodedata, unittest, unittest_mock, urllib3, urllib_error, urllib_parse, urllib_parse_extra, urllib_request, urllib_response, urllib_robotparser, uu, uuid, venv, warnings, warnings_extra, wave, weakref, weakref_extra, _weakref, webbrowser, wrapt, wsgiref, xdrlib, xml_dom, xml_minidom, xml_parse, xmlrpc_client, xmlrpc_server, xml_sax, zipapp, zipfile, zipimport, zlib, zoneinfo, zope_interface, zstd.

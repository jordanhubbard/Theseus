...
**352 specs · 6,303 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 352 ZSDL source specs (committed) |
...
**Covered libraries (352):** abc, abc_meta, accepts, aifc, ajv, antigravity, argparse, argparse_formatters, array, ast, asynchat, asyncio, asyncore, atexit, attrs, audioop, base64, bdb, binascii, bisect, _bisect, builtins, bytes, calendar, certifi, cgi, cgitb, chalk, chardet, charset_normalizer, chunk, click, cmath, cmd, code, codecs, codeop, collections, collections_abc, collections_namedtuple, collections_ordereddict, colorama, colorsys, compileall, concurrent_futures, configparser, content_type, contextlib, contextvars, cookie, copy, copyreg, cProfile, crypt, csv, _csv, csv_extra, ctypes, ctypes_module, curl, curses, curses_ascii, dataclasses, dataclasses_field, datetime, _datetime, datetime_timedelta, dbm, debug, decimal, _decimal, decorator, defusedxml, difflib, dis, distro, dns, doctest, docutils, dotenv, elementtree, email_charset, email_encoders, email_errors, email_header, email_message, email_mime, email_policy, email_utils, ensurepip, enum, enum_flags, errno, etag, expat, express, fcntl, filecmp, fileinput, filelock, fnmatch, fontTools, formatter, fractions, fresh, fsspec, ftplib, functools, functools_lru, future, gc, genericpath, getopt, getpass, gettext, glob, grp, gzip, hashlib, _hashlib, hashlib_extra, heapq, _heapq, hmac, html, html_entities, html_parser, http_client, http_cookiejar, http_cookies, http_server, http_status, idna, imaplib, imghdr, importlib, importlib_metadata, importlib_resources, importlib_util, inspect, inspect_signature, io, _io, ipaddress, isodate, itertools, itertools_product, jq, json, _json, json_decoder, json_encoder, json_extra, keyword, lib2to3, libcrypto, libpng, libsodium, libxml2, libyaml, linecache, locale, lodash, logging, logging_config, logging_handlers, lxml, lz4, lzma, mailbox, mailcap, markdown, markupsafe, marshal, math, media_typer, methods, mime_types, mimetypes, minimist, mmap, modulefinder, more_itertools, ms, msgpack, multiprocessing, netrc, networkx, nntplib, ntpath, nturl2path, numbers, numpy, object_inspect, openssl, operator, optparse, os, os_environ, os_path, os_stat, packaging, pathlib, pathlib_pure, pathspec, path_to_regexp, pcre2, pdb, pickle, _pickle, pickletools, pillow, pipes, pkgutil, platform, platformdirs, plistlib, pluggy, poplib, posix, posixpath, pprint, prettier, profile, protobuf, pstats, psutil, pty, pwd, pyclbr, py_compile, pydoc, pygments, pyparsing, pytz, pyyaml, qs, queue, quopri, random, range_parser, re, readline, re_patterns, reprlib, requests, resource, rich, rlcompleter, runpy, sched, secrets, select, selectors, semver, setuptools, shelve, shlex, shutil, signal, six, smtpd, smtplib, sndhdr, socket, _socket, socket_extra, socketserver, sqlite3, sqlite3_cli, ssl, _ssl, ssl_extra, stat, statistics, statistics_extra, statuses, stevedore, string, stringprep, struct, _struct, struct_extra, subprocess, subprocess_popen, sunau, symtable, sys, sysconfig, syslog, sys_platform, tabnanny, tarfile, telnetlib, tempfile, termios, textwrap, this, _thread, threading, threading_sync, time, timeit, tkinter, token, tokenize, tomli, tomlkit, tornado, trace, traceback, tracemalloc, traitlets, tty, turtle, types, typing, typing_extensions, typing_protocol, tzdata, unicodedata, unittest, unittest_mock, urllib3, urllib_error, urllib_parse, urllib_request, urllib_response, urllib_robotparser, uu, uuid, venv, warnings, wave, weakref, _weakref, webbrowser, wrapt, wsgiref, xdrlib, xml_dom, xml_minidom, xmlrpc_client, xmlrpc_server, xml_sax, zipapp, zipfile, zipimport, zlib, zoneinfo, zope_interface, zstd.

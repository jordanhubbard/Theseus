...
**171 specs · 3,654 invariants · 3,203 tests · 100% top-50 pipeline coverage**
...
| Component | Purpose |
|-----------|---------|
| `zspecs/*.zspec.zsdl` | 171 ZSDL source specs (committed) |
...
**Covered libraries (171):** abc, accepts, ajv, argparse, array, ast, asyncio, attrs, base64, binascii, bisect, bytes, calendar, certifi, chalk, chardet, charset_normalizer, click, cmath, codecs, collections, colorama, concurrent_futures, configparser, content_type, contextlib, cookie, copy, csv, curl, dataclasses, datetime, debug, decimal, decorator, defusedxml, difflib, dis, distro, dns, docutils, dotenv, elementtree, email_utils, enum, etag, expat, express, filelock, fnmatch, fontTools, fractions, fresh, fsspec, functools, gc, getpass, glob, gzip, hashlib, heapq, hmac, html, http_client, http_server, idna, importlib, inspect, io, ipaddress, isodate, itertools, jq, json, json_encoder, keyword, libcrypto, libpng, libsodium, libxml2, libyaml, lodash, logging, lxml, lz4, markdown, markupsafe, marshal, math, media_typer, methods, mime_types, minimist, more_itertools, ms, msgpack, multiprocessing, networkx, numpy, object_inspect, openssl, operator, os_path, packaging, path_to_regexp, pathlib, pathspec, pcre2, pillow, platform, platformdirs, pluggy, pprint, prettier, protobuf, psutil, pygments, pyparsing, pytz, pyyaml, qs, queue, random, range_parser, re, reprlib, requests, rich, secrets, semver, setuptools, shlex, signal, six, socket, sqlite3, sqlite3_cli, statistics, statuses, stevedore, string, struct, subprocess, sys, tarfile, tempfile, textwrap, threading, time, token, tomli, tomlkit, tornado, traceback, traitlets, types, typing, typing_extensions, tzdata, unicodedata, urllib_parse, urllib_request, urllib3, uuid, warnings, weakref, wrapt, zipfile, zlib, zope_interface, zstd.
